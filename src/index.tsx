...
export const useResponsive = (breakpoints: BreakpointsProps = defaultBreakpoints) => {
  const {sm, md, lg, xl} = breakpoints;

  return <T extends React.FunctionComponent>(Component: React.FunctionComponent, values: ResponsiveProps<T>) => {
